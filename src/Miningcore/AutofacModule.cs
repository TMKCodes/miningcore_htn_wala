...
//using Miningcore.Crypto.Hashing.Algorithms.Hoohash;
...
public class AutofacModule : Module
{
    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        // elva -- new scheme
        builder.RegisterType<PPLNS10PaymentScheme>()
            .Keyed<IPayoutScheme>(PayoutScheme.PPLNS10)
            .SingleInstance();

        // elva -- new scheme
        builder.RegisterType<PPLNS70PaymentScheme>()
            .Keyed<IPayoutScheme>(PayoutScheme.PPLNS70)
            .SingleInstance();
