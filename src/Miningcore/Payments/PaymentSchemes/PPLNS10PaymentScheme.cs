...
/// <summary>
/// PPLNS10 payout scheme implementation
/// </summary>
// ReSharper disable once InconsistentNaming
public class PPLNS10PaymentScheme : IPayoutScheme
{
    public PPLNS10PaymentScheme(
    ...
    private static readonly ILogger logger = LogManager.GetLogger("PPLNS10 Payment");
        ...
        Block block, decimal blockReward, CancellationToken ct)
    {
        ...
        logger.Info(() => $"elva PPLNS10 - CalculateRewardsAsync Strating - poolConfig {poolConfig} - payoutConfig {payoutConfig}");


        // PPLNS10 window (see https://bitcointalk.org/index.php?topic=39832)
