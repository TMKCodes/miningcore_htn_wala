...
public static unsafe class Multihash
{
    ...
    [DllImport("libmultihash", EntryPoint = "Hoohash_export", CallingConvention = CallingConvention.Cdecl)]
    public static extern void Hoohash(byte* input, void* output, uint inputLength);
