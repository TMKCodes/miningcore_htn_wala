...
using Autofac; // Pour IComponentContext
using Miningcore.Crypto; // Pour IHashAlgorithm
...
public abstract partial class CoinTemplate
{
    ...
    public static readonly Dictionary<CoinFamily, Type> Families = new()
    {
        ...
        {CoinFamily.Scash, typeof(ScashTemplate)},
    };
}
...
public partial class ScashTemplate : CoinTemplate
{
    ...
    */
    public class ScashNetworkParams
    {
        ...
        /// <summary>
        /// Port RPC pour le réseau
        /// </summary>
        public int RpcPort { get; set; }

        /// <summary>
        /// Préfixe Bech32 pour les adresses SegWit
        /// </summary>
        public string Bech32Prefix { get; set; }

        /// <summary>
        /// Indique si SegWit est supporté
        /// </summary>
        public bool SupportsSegWit { get; set; }
    }
...
public partial class PoolConfig
{
    ...
    [JsonProperty("networkTypeOverride")]
    public string NetworkTypeOverride { get; set; }
}
