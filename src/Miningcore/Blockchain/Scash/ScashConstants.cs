...
public enum ScashTransactionCategory
{
    /// <summary>
...
public class ScashConstants
{
    public const int ExtranoncePlaceHolderLength = 8;
    public const decimal SatoshisPerScash = 100000000;
...
public enum ScashRPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in Scashd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9, //!< Scash is not connected
...
public static class ScashCommands
{
