...
public class ScashJobManager : ScashJobManagerBase<ScashJob>
{
    ...
    {
        this.randomX = randomX ?? throw new ArgumentNullException(nameof(randomX));
    }
    ...
    protected override void PostChainIdentifyConfigure()
    {
        ...
        RandomX.WithLock(() =>
        {
            var seedHex = "default_scash_seed";
            Console.WriteLine($"elva Debug ScashJob -----> WithLock: Initialisation du seed '{seedHex}' avec Realm='scash'.");

            RandomX.CreateSeed("scash", seedHex, flagsOverride: null, vmCount: 4);
    ...
    */
    ...
    public virtual object[] GetSubscriberData(StratumConnection worker)
    {
        ...
        {
            context.ExtraNonce1,
            ScashConstants.ExtranoncePlaceHolderLength - ExtranonceBytes,
        };
