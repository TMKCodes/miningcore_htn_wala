...
namespace Miningcore.Blockchain.Scash.Configuration;

public class ScashPoolConfigExtra
{
    public ScashAddressType AddressType { get; set; } = ScashAddressType.Legacy;
    ...
    /// <summary>
    /// Set to true to limit RPC commands to old Scash command set
    /// </summary>
    ...
    /// Overrides property of same name from ScashTemplate
    /// </summary>
