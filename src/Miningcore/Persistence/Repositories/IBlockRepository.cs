...
public interface IBlockRepository
{
    ...
    Task<bool> BlockExistsAsync(IDbConnection con, string poolId, string blockHash, CancellationToken ct);
    ...
    Task<uint> UpdateBlockStatusAndRewardAsync(IDbConnection con, string poolId, long blockHeight, string blockHash, BlockStatus status, decimal reward);
}
